...
module.exports.initialize = (spec, plugins, options) => {
    var y = Object.create(new events.EventEmitter(), {
        spec:    { writable: false, configurable: false, value: spec    || {} },
        plugins: { writable: false, configurable: false, value: plugins || {} },
        options: { writable: false, configurable: false, value: options || {} }
    });
